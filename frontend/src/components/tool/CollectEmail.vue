...
<div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
    <form class="space-y-6" action="#">
        <h5 class="text-xl font-medium text-gray-900 dark:text-white">Enter your email address</h5>
        <div>
        ...
        <div class="flex items-start mb-6">
            ...
            <label for="share" style="max-width: 280px;" class=" ml-2 text-sm font-medium text-gray-900 dark:text-gray-300" >Share your CV with our vetted companies and recruiters</label>
          </div>
          <div class="flex items-start mb-6">
            <div class="flex items-center h-5">
                <slot name="terms" />
            </div>
            <label for="remember" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300" >I agree to Cuverly’s <a href="https://cuverly.com/t&c" target="_blank" style="text-decoration: underline;" v-text="'Terms & Conditions'"></a></label>
          </div>
       <slot name="submit"/>
