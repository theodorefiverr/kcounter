 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sa=ea;function or(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const i=Object.assign({name:bn,automaticDataCollectionEnabled:!1},e),r=i.name;if(typeof r!="string"||!r)throw he.create("bad-app-name",{appName:String(r)});if(n||(n=er()),!n)throw he.create("no-options");const s=Ct.get(r);if(s){if(Ot(n,s.options)&&Ot(i,s.config))return s;throw he.create("duplicate-app",{appName:r})}const o=new fo(r);for(const a of yn.values())o.addComponent(a);const c=new ra(n,i,o);return Ct.set(r,c),c}function ar(t=bn){const e=Ct.get(t);if(!e&&t===bn&&er())return or();if(!e)throw he.create("no-app",{appName:t});return e}function ee(t,e,n){var i;let r=(i=ta[t])!==null&&i!==void 0?i:t;n&&(r+=`-${n}`);const s=r.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const c=[`Unable to register library "${r}" with version "${e}":`];s&&c.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&o&&c.push("and"),o&&c.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Le.warn(c.join(" "));return}ge(new re(`${r}-version`,()=>({library:r,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const oa="firebase-heartbeat-database",aa=1,nt="firebase-heartbeat-store";let rn=null;function cr(){return rn||(rn=Ao(oa,aa,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(nt)}}}).catch(t=>{throw he.create("idb-open",{originalErrorMessage:t.message})})),rn}async function ca(t){try{return await(await cr()).transaction(nt).objectStore(nt).get(lr(t))}catch(e){if(e instanceof ve)Le.warn(e.message);else{const n=he.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Le.warn(n.message)}}}async function gi(t,e){try{const i=(await cr()).transaction(nt,"readwrite");await i.objectStore(nt).put(e,lr(t)),await i.done}catch(n){if(n instanceof ve)Le.warn(n.message);else{const i=he.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});Le.warn(i.message)}}}function lr(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hr=1e4,pr=`w:${Ln}`,gr="FIS_v2",ka="https://firebaseinstallations.googleapis.com/v1",xa=60*60*1e3,Oa="installations",Ca="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Td(t){if(t.length===0)return null;const e=t.lastIndexOf("/");return e===-1?"":t.slice(0,e)}function Id(t,e){const n=e.split("/").filter(i=>i.length>0).join("/");return t.length===0?n:t+"/"+n}function hs(t){const e=t.lastIndexOf("/",t.length-2);return e===-1?t:t.slice(e+1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ad(t,e){return e}class R{constructor(e,n,i,r){this.server=e,this.local=n||e,this.writable=!!i,this.xform=r||Ad}}let Tt=null;function kd(t){return!Xt(t)||t.length<2?t:hs(t)}function ps(){if(Tt)return Tt;const t=[];t.push(new R("bucket")),t.push(new R("generation")),t.push(new R("metageneration")),t.push(new R("name","fullPath",!0));function e(s,o){return kd(o)}const n=new R("name");n.xform=e,t.push(n);function i(s,o){return o!==void 0?Number(o):o}const r=new R("size");return r.xform=i,t.push(r),t.push(new R("timeCreated")),t.push(new R("updated")),t.push(new R("md5Hash",null,!0)),t.push(new R("cacheControl",null,!0)),t.push(new R("contentDisposition",null,!0)),t.push(new R("contentEncoding",null,!0)),t.push(new R("contentLanguage",null,!0)),t.push(new R("contentType",null,!0)),t.push(new R("metadata","customMetadata",!0)),Tt=t,Tt}function xd(t,e){function n(){const i=t.bucket,r=t.fullPath,s=new V(i,r);return e._makeStorageReference(s)}Object.defineProperty(t,"ref",{get:n})}function Od(t,e,n){const i={};i.type="file";const r=n.length;for(let s=0;s<r;s++){const o=n[s];i[o.local]=o.xform(i,e[o.server])}return xd(i,t),i}function gs(t,e,n){const i=fs(e);return i===null?null:Od(t,i,n)}function Cd(t,e,n,i){const r=fs(e);if(r===null||!Xt(r.downloadTokens))return null;const s=r.downloadTokens;if(s.length===0)return null;const o=encodeURIComponent;return s.split(",").map(l=>{const u=t.bucket,d=t.fullPath,h="/b/"+o(u)+"/o/"+o(d),f=lt(h,n,i),m=as({alt:"media",token:l});return f+m})[0]}function ms(t,e){const n={},i=e.length;for(let r=0;r<i;r++){const s=e[r];s.writable&&(n[s.server]=t[s.local])}return JSON.stringify(n)}class We{constructor(e,n,i,r){this.url=e,this.method=n,this.handler=i,this.timeout=r,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ne{constructor(e,n){this._service=e,n instanceof V?this._location=n:this._location=V.makeFromUrl(n,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,n){return new Ne(e,n)}get root(){const e=new V(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return hs(this._location.path)}get storage(){return this._service}get parent(){const e=Td(this._location.path);if(e===null)return null;const n=new V(this._location.bucket,e);return new Ne(this._service,n)}_throwIfRoot(e){if(this._location.path==="")throw td(e)}}function Hd(t,e,n){return t._throwIfRoot("uploadBytesResumable"),new Fd(t,new ue(e),n)}function Vd(t){t._throwIfRoot("getDownloadURL");const e=Ld(t.storage,t._location,ps());return t.storage.makeRequestWithTokens(e,Ue).then(n=>{if(n===null)throw Qu();return n})}function qd(t,e){const n=Id(t._location.path,e),i=new V(t._location.bucket,n);return new Ne(t.storage,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
