Ki67_counter_v3 MATLAB Python Package
...
2. Installing the Ki67_counter_v3 Package

A. Change to the directory that contains the file setup.py and the subdirectory 
Ki67_counter_v3. If you do not have write permissions, copy all its contents to a 
...
3. Using the Ki67_counter_v3 Package

The Ki67_counter_v3 package is on your Python path. To import it into a Python script or 
session, execute:
